...
@allure.feature('Create publications')
@allure.story('Post publications')
@allure.suite('CRUD with publications')
...
def test_create_obj(start_end):
    ...
    with allure.step('Asserting respone is 200'):
        assert response.status_code == 200, 'Status code is not 200'
    with allure.step('Asserting publication name is valid'):
        assert response.json()['name'] == body['name'], 'Invalid name'
    PostResp(**response.json())


@allure.suite('CRUD with publications')
@allure.feature('GET publications')
@allure.story('Get all publications')
...
@allure.suite('CRUD with publications')
@allure.feature('GET publications')
@allure.story('Get publications by id')
...
@allure.suite('CRUD with publications')
@allure.feature('UPDATE publications')
@allure.story('Update publications full')
...
@allure.suite('CRUD with publications')
@allure.feature('UPDATE publications')
@allure.story('Update publications partially')
...
@allure.suite('CRUD with publications')
@allure.feature('DELETE publications')
