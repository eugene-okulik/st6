...
def test_duplicate_email_registration(create_account):
    ...
    expected_redirection = 'https://magento.softwaretestingboard.com/customer/account/create/'
    create_account.verify_redirection_account_create(expected_redirection)
